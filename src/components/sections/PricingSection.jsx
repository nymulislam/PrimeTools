...
const PricingSection = () => {
    return (
        <div id='pricing' className='space-y-20 py-20'>
                ...
                <div className="card w-full bg-base-100 shadow-sm hover:shadow-lg transition duration-300">
                    <div className="card-body">
                        <div>
                            ...
                            <span className="text-xl block my-4"><span className='text-2xl font-semibold'>$0</span>/Month</span>
                        </div>
                        <ul className="flex flex-col gap-2 text-xs mb-14">
                            <li>
                ...
                <div className="card w-full bg-base-100 shadow-sm hover:shadow-lg transition duration-300">
                    <div className="card-body">
                        <div className="">
                            ...
                            <span className="text-xl block my-4"><span className='text-2xl font-semibold'>$99</span>/Month</span>
                        </div>
                        <ul className="flex flex-col gap-2 text-xs">
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" /></svg>
